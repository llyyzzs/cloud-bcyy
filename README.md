...
莞工聘是基于微信小程序开发的一种在线平台，后端使用SpringBoot、SpringCloud、MySQL、MyBatis、Redis、RabbitMQ、Elasticsearch、Seata、Sentinel、Minio、JWT等开源搭建而成微服务，项目旨在连接学生和雇主，提供灵活的用工服务。企业或者学校可通过小程序发布招聘信息，系统会对岗位进行审核、公布。 学生可查看招聘详情以及雇主信息，或在线报名投递简历、与雇主沟通交流。雇主筛选简历确定合适的人选，之后再进行面试。该项目主要用于学校和学生之间的雇用、或者校招企业的使用。
